    ...
    <div className="min-h-screen font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-10 flex flex-col gap-8">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Åtgärder</h1>
        ...
        {!loading && actions.length > 0 && (
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/30 backdrop-blur-2xl border border-white/40 relative shadow-[0_8px_32px_rgba(31,38,135,0.08)] before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/80 before:to-transparent rounded-xl px-5 py-4 shadow-sm text-center">
        ...
        {loading ? (
          ...
          <div className="bg-white/30 backdrop-blur-2xl border border-white/40 relative shadow-[0_8px_32px_rgba(31,38,135,0.08)] before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/80 before:to-transparent rounded-2xl p-10 text-center text-gray-400 text-sm">
...
function ActionCard({ action, done, onToggle }: { action: Action; done: boolean; onToggle: () => void }) {
  ...
  return (
    <div className={`bg-white/30 backdrop-blur-2xl border border-white/40 relative shadow-[0_8px_32px_rgba(31,38,135,0.08)] before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/80 before:to-transparent rounded-2xl overflow-hidden shadow-sm transition-all duration-300 ${done ? 'opacity-70' : 'hover:shadow-md'}`}>
      {/* Urgency strip */}
