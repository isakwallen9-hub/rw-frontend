          ...
          <>
            {loadingRunway || loadingSeries ? (
              ...
              <>
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {/* Current balance */}
                  <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl p-6 shadow-[0_4px_28px_rgba(37,99,235,0.12)]">
                  ...
                  {/* Monthly inflow */}
                  <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl p-6 shadow-[0_4px_28px_rgba(22,163,74,0.12)]">
                  ...
                  {/* Monthly outflow */}
                  <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl p-6 shadow-[0_4px_28px_rgba(239,68,68,0.12)]">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl shadow-sm px-6 py-5 flex items-center gap-4">
                    {monthlyNet >= 0
          ...
          <>
            ...
            {!loadingSeries && (
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 bg-white/70 backdrop-blur-xl border border-white/50 rounded-xl px-4 py-2.5 shadow-sm">
        ...
        {tab === 'forecast' && (
          <>
            ...
            {loadingRunway ? (
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl shadow-sm px-5 py-4">
