          ...
          <>
            {loadingRunway || loadingSeries ? (
              ...
              <>
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {/* Current balance */}
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 border-l-4 border-l-blue-500">
                  ...
                  {/* Monthly inflow */}
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 border-l-4 border-l-green-500">
                  ...
                  {/* Monthly outflow */}
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 border-l-4 border-l-red-500">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-sm px-6 py-5 flex items-center gap-4">
                    {monthlyNet >= 0
