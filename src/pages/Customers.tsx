  ...
  return (
    <div className="font-sans">
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 flex flex-col gap-8">
        ...
        {/* AI kundrisk-banner */}
        {customerRisk && (
          <div className="bg-amber-50/70 backdrop-blur border border-amber-200/70 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <button
              ...
              className="shrink-0 flex items-center gap-1.5 text-xs font-semibold text-amber-700 border border-amber-300 rounded-xl px-4 py-2.5 hover:bg-amber-100 transition-colors whitespace-nowrap min-h-[44px]"
            >
