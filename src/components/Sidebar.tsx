    ...
    <div className="flex flex-col h-full select-none">
      ...
      <div className="px-2 pb-5 shrink-0 border-t border-slate-200/50 pt-3">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-red-50/60 hover:text-red-700 transition-colors w-full mt-1 min-h-[44px]"
        >
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 rounded-lg bg-white/80 backdrop-blur-xl border border-slate-200/60 shadow-sm"
      ...
      {mobileOpen && (
        <>
          <div
            ...
            aria-hidden="true"
          />
          <aside className="lg:hidden fixed inset-y-0 left-0 w-72 bg-white/95 backdrop-blur-2xl border-r border-slate-200/60 z-50 shadow-2xl flex flex-col">
